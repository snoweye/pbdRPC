...
\section[An Application Using \pkg{pbdCS}]{An Application Using \pkg{pbdCS}}
\label{sec:application_cs}
\addcontentsline{toc}{section}{\thesection. An Application Using \pkg{pbdCS}}
...
The details of \code{RPC.CS} are in next.
